// Web Components Bundle - All components in one file
// This approach follows the pattern of: React components, Vue SFC, LitElement

// Data is from window.profileData (set in index.html)
// Icons are from window.customIcons (set in index.html)
            ...
            <section id="home" class="min-h-screen flex items-center justify-center pt-24 px-4 relative overflow-hidden">
                ...
                <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10 animate-on-scroll">
                    ...
                    <div>
                        ...
                        <h1 class="text-5xl md:text-6xl font-bold mb-4 text-white">Hi, I'm <span class="gradient-text">${data.name.display}</span></h1>
                        <p class="text-lg text-slate-400 mb-2 font-mono">${data.name.full} - ${data.name.english}</p>
                        <p class="text-xl text-slate-300 mb-6 leading-relaxed">${experience}+ years of experience building scalable web and mobile applications with modern technologies. Specialized in microservices, AI integration, and full-stack development.</p>
                        <div class="flex flex-wrap gap-3 mb-8">
                            ...
                            <div class="flex items-center space-x-2 px-4 py-2 bg-slate-800/50 border border-slate-700/50 rounded-lg">
                                <svg class="w-5 h-5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                                <span class="text-slate-300 text-sm">${age} Years Old</span>
                            </div>
                        </div>
                        <div class="flex flex-wrap gap-4">
                            <a href="#projects" class="px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-500 text-white rounded-lg hover:from-purple-700 hover:to-blue-600 transition-all duration-200 cursor-pointer shadow-lg hover:shadow-xl font-medium">View Projects</a>
                            ...
                            <a href="#contact" class="px-8 py-3 bg-slate-800 border border-slate-700 text-white rounded-lg hover:border-purple-500 hover:bg-slate-700 transition-all duration-200 cursor-pointer font-medium">Contact Me</a>
                        </div>
                    </div>
                </div>
            </section>
