            ...
            <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10 animate-on-scroll">
                ...
                <div class="flex justify-center md:justify-end">
                    <div class="relative">
                        ...
                        <img src="assets/avatar.jpg" alt="${profileData.name.full}" class="relative w-80 h-80 object-cover rounded-3xl border-4 border-purple-500/30 shadow-2xl">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <h1 class="text-5xl md:text-6xl font-bold mb-4 text-white">
                        Hi, I'm <span class="gradient-text">${profileData.name.display}</span>
                    </h1>
                    <p class="text-lg text-slate-400 mb-2 font-mono">${profileData.name.full} - ${profileData.name.english}</p>
                    <p class="text-xl text-slate-300 mb-6 leading-relaxed">
                        <span id="experience-years"></span> years of experience building scalable web and mobile applications with modern technologies. Specialized in microservices, AI integration, and full-stack development.
                    </p>
                    <div class="flex flex-wrap gap-3 mb-8">
                        <div class="flex items-center space-x-2 px-4 py-2 bg-slate-800/50 border border-slate-700/50 rounded-lg">
                            ...
                            <span class="text-slate-300 text-sm">${profileData.contact.location}</span>
                        </div>
                        <div class="flex items-center space-x-2 px-4 py-2 bg-slate-800/50 border border-slate-700/50 rounded-lg">
                            <svg class="w-5 h-5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                            </svg>
                            <span class="text-slate-300 text-sm"><span id="age-display">${age}</span> Years Old</span>
                        </div>
                    </div>
